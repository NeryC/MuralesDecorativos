  ...
  try {
    ...
    if (action === "reject") {
      ...
      const responseBody = auditoriaOk
        ...
        : {
            ...
            action: "reject",
            data: updatedMod,
            _auditWarning: "Acción completada pero no se pudo registrar en auditoría.",
          };
    ...
    const updateMuralData = {
      ...
      imagen_thumbnail_url:
        modificacion.nueva_imagen_thumbnail_url || mural.imagen_thumbnail_url || null,
      comentario:
    ...
    if (fetchOthersError) {
      ...
      if (rejectOthersError) {
        console.error("Error rejecting other pending modifications for mural:", rejectOthersError);
